...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>상위 스코프의 어떤 식별자도 참조하지 않는 함수는 클로저가 아니다.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>중첩 함수 bar는 외부 함수보다 더 오래 유지되고 상위 스코프의 식별자를 참고하므로 클로저다.</p></figcaption></figure>
