...
constructor는 인스턴스를 생성하고 초기화하기 위한 메서드다. 이름 변경이 불가능하다.
...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>클래스는 함수다</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p>Person 클래스로 생성한 인스턴스</p></figcaption></figure>
